...
1. **Ingests** ~575 IPF/PF clinical trials from the [ClinicalTrials.gov v2 API](https://clinicaltrials.gov/data-api/api), filtering out false-positive matches (e.g. cystic fibrosis) that simple keyword search picks up
